...
import lexi.language.kotlin.languages.antlr.kotlin.KotlinParser.PropertyDeclarationContext
import lexi.language.kotlin.languages.kotlin.ast.{KtFunction, KtProperty}
